...
class ComercializationEmbrapaScraper(ComercializationRepository):
    def fetch_all(self, year: int) -> List[Product]:
        """
        Fetch all comercialization data for a given year.
        """
    ...
    def _parse_table(self, table: BeautifulSoup, year: int) -> List[Dict]:
        """
        Parse the data table and extract Comercialization data.
        """
        data = []
        category = None
