...
class ProcessingService:
    ...
    def get_all_products(self, year: int, sub_option: str, product_filter: Filter = None):
        products = self.processing_repository.fetch_all(year=year, sub_option=sub_option)
        if product_filter:
