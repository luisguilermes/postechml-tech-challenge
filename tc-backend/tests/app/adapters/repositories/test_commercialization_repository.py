...
@patch(
    "app.adapters.repositories.commercialization_repository.fetch_commercialization_embrapa"
)
@patch(
    "app.adapters.repositories.commercialization_repository.CommercializationRepositoryIml._fetch_by_year_from_db"
)
def test_fetch_by_year_returns_commercialization_data_on_success(
    ...
    repo = CommercializationRepositoryIml(db=MagicMock(), background_tasks=MagicMock())
...
@patch("app.adapters.repositories.commercialization_repository.CommercializationModel")
def test_upsert_production_updates_existing_record(mock_production_model):
    ...
    repo = CommercializationRepositoryIml(db=mock_session, background_tasks=MagicMock())
